...
def create_train_val_test_folders(base_dir, train_size=0.65, val_size=0.15, test_size=0.2):
    ...
    - train_size (float): The proportion of the dataset to include in the train split (default is 0.65).
    ...
    for folder in folders:
        ...
        val, test = train_test_split(temp, train_size=val_size / (val_size + test_size), random_state=42)
